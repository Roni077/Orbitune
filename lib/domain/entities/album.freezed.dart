...
mixin _$Album {
 ...
 String get id; String get name; String get artist; String? get artworkUrl; int? get year; int get trackCount;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,artist,artworkUrl,year,trackCount);

@override
String toString() {
  return 'Album(id: $id, name: $name, artist: $artist, artworkUrl: $artworkUrl, year: $year, trackCount: $trackCount)';
}
...
@useResult
$Res call({
 String id, String name, String artist, String? artworkUrl, int? year, int trackCount
});
...
/// Create a copy of Album
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? artist = null,Object? artworkUrl = freezed,Object? year = freezed,Object? trackCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String artist,  String? artworkUrl,  int? year,  int trackCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Album() when $default != null:
return $default(_that.id,_that.name,_that.artist,_that.artworkUrl,_that.year,_that.trackCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String artist,  String? artworkUrl,  int? year,  int trackCount)  $default,) {final _that = this;
switch (_that) {
case _Album():
return $default(_that.id,_that.name,_that.artist,_that.artworkUrl,_that.year,_that.trackCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String artist,  String? artworkUrl,  int? year,  int trackCount)?  $default,) {final _that = this;
switch (_that) {
case _Album() when $default != null:
return $default(_that.id,_that.name,_that.artist,_that.artworkUrl,_that.year,_that.trackCount);case _:
  return null;
...
class _Album implements Album {
  const _Album({required this.id, required this.name, required this.artist, this.artworkUrl, this.year, this.trackCount = 0});
...
/// Create a copy of Album
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? artist = null,Object? artworkUrl = freezed,Object? year = freezed,Object? trackCount = null,}) {
  return _then(_Album(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,artist: null == artist ? _self.artist : artist // ignore: cast_nullable_to_non_nullable
