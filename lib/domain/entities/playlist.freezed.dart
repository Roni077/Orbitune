...
mixin _$Playlist {
 ...
 String get id; String get name; List<String> get trackIds; String? get coverUrl; bool get isFavoritePlaylist; DateTime? get createdAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Playlist&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.trackIds, trackIds)&&(identical(other.coverUrl, coverUrl) || other.coverUrl == coverUrl)&&(identical(other.isFavoritePlaylist, isFavoritePlaylist) || other.isFavoritePlaylist == isFavoritePlaylist)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}


@override
int get hashCode => Object.hash(runtimeType,id,name,const DeepCollectionEquality().hash(trackIds),coverUrl,isFavoritePlaylist,createdAt);

@override
String toString() {
  return 'Playlist(id: $id, name: $name, trackIds: $trackIds, coverUrl: $coverUrl, isFavoritePlaylist: $isFavoritePlaylist, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String name, List<String> trackIds, String? coverUrl, bool isFavoritePlaylist, DateTime? createdAt
});
...
/// Create a copy of Playlist
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? trackIds = null,Object? coverUrl = freezed,Object? isFavoritePlaylist = null,Object? createdAt = freezed,}) {
...
as String?,isFavoritePlaylist: null == isFavoritePlaylist ? _self.isFavoritePlaylist : isFavoritePlaylist // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  List<String> trackIds,  String? coverUrl,  bool isFavoritePlaylist,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Playlist() when $default != null:
return $default(_that.id,_that.name,_that.trackIds,_that.coverUrl,_that.isFavoritePlaylist,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  List<String> trackIds,  String? coverUrl,  bool isFavoritePlaylist,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _Playlist():
return $default(_that.id,_that.name,_that.trackIds,_that.coverUrl,_that.isFavoritePlaylist,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  List<String> trackIds,  String? coverUrl,  bool isFavoritePlaylist,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Playlist() when $default != null:
return $default(_that.id,_that.name,_that.trackIds,_that.coverUrl,_that.isFavoritePlaylist,_that.createdAt);case _:
  return null;
...
class _Playlist implements Playlist {
  const _Playlist({required this.id, required this.name, final  List<String> trackIds = const [], this.coverUrl, this.isFavoritePlaylist = false, this.createdAt}): _trackIds = trackIds;
...
@override@JsonKey() final  bool isFavoritePlaylist;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,const DeepCollectionEquality().hash(_trackIds),coverUrl,isFavoritePlaylist,createdAt);
...
/// Create a copy of Playlist
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? trackIds = null,Object? coverUrl = freezed,Object? isFavoritePlaylist = null,Object? createdAt = freezed,}) {
