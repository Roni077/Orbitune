...
mixin _$Artist {
 ...
 String get id; String get name; String? get imageUrl; int get albumCount; int get trackCount;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,imageUrl,albumCount,trackCount);

@override
String toString() {
  return 'Artist(id: $id, name: $name, imageUrl: $imageUrl, albumCount: $albumCount, trackCount: $trackCount)';
}
...
@useResult
$Res call({
 String id, String name, String? imageUrl, int albumCount, int trackCount
});
...
/// Create a copy of Artist
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? imageUrl = freezed,Object? albumCount = null,Object? trackCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? imageUrl,  int albumCount,  int trackCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Artist() when $default != null:
return $default(_that.id,_that.name,_that.imageUrl,_that.albumCount,_that.trackCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? imageUrl,  int albumCount,  int trackCount)  $default,) {final _that = this;
switch (_that) {
case _Artist():
return $default(_that.id,_that.name,_that.imageUrl,_that.albumCount,_that.trackCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? imageUrl,  int albumCount,  int trackCount)?  $default,) {final _that = this;
switch (_that) {
case _Artist() when $default != null:
return $default(_that.id,_that.name,_that.imageUrl,_that.albumCount,_that.trackCount);case _:
  return null;
...
class _Artist implements Artist {
  const _Artist({required this.id, required this.name, this.imageUrl, this.albumCount = 0, this.trackCount = 0});
...
/// Create a copy of Artist
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? imageUrl = freezed,Object? albumCount = null,Object? trackCount = null,}) {
